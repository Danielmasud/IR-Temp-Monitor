...
![Project Running](docs/project_working.jpg)
...
5. Point the remote at the receiver and press the designated button (configured to `0xBC43FF00`) to toggle the system.
